...
In order to make it work, you need to:
  ...
  - Go to your github repo settings and a webhook with content type \`json\` and with the secret you defined in your envs, selecting **only** Pull requests events and point it to ${process.env.SERVER_URL}/webhook/pr
  - Done!
`
    );
  },
